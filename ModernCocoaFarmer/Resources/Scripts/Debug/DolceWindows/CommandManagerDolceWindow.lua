...
function CommandManagerDolceWindow:addCommands()
    ...
    self._commands["FinishGame"] = require 'Commands.State.FinishGame'
    self._commands["LoadGame"] = require 'Commands.State.LoadGame'
    self._commands["SaveGame"] = require 'Commands.State.SaveGame'
    self._commands["NewGame"] = require 'Commands.State.NewGame'
